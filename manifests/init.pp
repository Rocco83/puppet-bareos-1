...
class bareos (
  ...
  $repo_avail_hash  = $::bareos::params::repo_avail_hash,
  $repo_manage_hash = $::bareos::params::repo_manage_hash,
  ...
  if $manage_repo {
    class {'::bareos::repository':
      release          => $::bareos::repo_release,
      repo_avail_hash  => $::bareos::repo_avail_hash,
      repo_manage_hash => $::bareos::repo_manage_hash
    }
  }
